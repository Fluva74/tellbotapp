...
import { StyleSheet, SafeAreaView, View, TextInput, ActivityIndicator } from 'react-native';
...
const CustomInputToolbar = (props) => {
  ...
  return (
    <View style={{ padding: 8 }}>
      <TextInput
        style={{ padding: 12, borderColor: '#ccc', borderWidth: 1, borderRadius: 4 }}
...
const App = () => {
  ...
  headers: {
    ...
    Authorization: `Bearer <<<ENTER THE API KEY HERE>>>`,
  },
  body: JSON.stringify({
    model: 'gpt-3.5-turbo',
    messages: [ 
    ...
    stop: '\n',
      ...
      if (chatbotResponseJson.choices && chatbotResponseJson.choices.length > 0) {
        const chatbotResponseText = chatbotResponseJson.choices[0].message.content;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <GiftedChat
        ...
        renderInputToolbar={(toolbarProps) => (
          <CustomInputToolbar onSend={(newMessages) => onSend(newMessages)} {...toolbarProps} />
        )}
        renderAvatar={null}
